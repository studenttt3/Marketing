...
st.subheader("И еще немного рекомендаций...")
st.markdown("Но это еще не всё! Теперь давайте остановимся на категории косметики. Мы хотим дать вам еще больше рекомендаций, основываясь на том, какие бренды косметики нравились пользователям, похожим на вас. При этом мы хотим минимизировать ваше недовольство. Пожалуйста, выберите из следующих списков брендов тот, который нравится вам меньше всего.")
